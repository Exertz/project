...
<body>
    <header>
        <nav style="background-color: #8AC4FF;">
            <div class="navbar">
                <div class="logo">
    ...
    <div class="container-1 d-flex">
        <div class="w-100 home-left d-flex flex-column align-items-center">
            <p class="home-message" style="width: 50%; line-height: 3rem;">Transform Your Vision into Reality:
                REGISTER Now!
        ...
        <!-- <a href="#" class="register_btn">Register</a>
            <div class="toggle_btn:register"></div> -->
